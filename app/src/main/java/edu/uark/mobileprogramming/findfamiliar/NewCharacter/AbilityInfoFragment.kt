 ...
 * Use the [AbilityInfoFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AbilityInfoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AbilityInfoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AbilityInfoFragment().apply {
